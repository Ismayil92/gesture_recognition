...
def parse_opts():
    ...
    parser.add_argument('--root_path', default='/home/dlar/tensorflow2/applications/gesture_recognition', type=str, help = 'Root director path of data')
    parser.add_argument('--video_path', default='/home/dlar/tensorflow2/applications/gesture_recognition/datasets/Jester_dataset/20bn-jester-v1', type=str, help = 'Directory path of videos')
    parser.add_argument('--annotation_path', default='datasets/annotations/Jester', type=str, help = 'Annotation file path')
    parser.add_argument('--train_list', default='train_videofolder.txt', type=str, help='File name of train list')
    parser.add_argument('--val_list', default='val_videofolder.txt', type=str, help='File name of val list')
...
# ========================= Training Configs ==========================
    ...
    parser.add_argument('--lr_patience', default=2, type=int, help='Patience of LR scheduler. See documentation of ReduceLROnPlateau.')
